...
Future<void> handleGDPRConsent() async {
  try {
    ...
    ConsentInformation.instance.requestConsentInfoUpdate(params, () async {
      print(
          "GDPR Consent: Consent info updated. Status: ${await ConsentInformation
              .instance.getConsentStatus()}");
      ...
      print('GDPR Consent: Error requesting consent info update: ${error
          .message}');
...
Future<void> _loadAndShowConsentForm() async { // Changed to Future<void> and made async
  try {
    ConsentForm.loadConsentForm( // Added await
        ...
        print(
            "GDPR Consent: Form loaded. Current status: ${await ConsentInformation
                .instance.getConsentStatus()}");
        ...
        if (await ConsentInformation.instance.getConsentStatus() ==
          ...
          consentForm.show((FormError? formError) async { // Made callback async
            if (formError != null) {
              print('GDPR Consent: Error showing consent form: ${formError
                  .message}');
            }
  ...
  try {
    ...
    ConsentForm.loadConsentForm( // Added await
        ...
        consentForm.show(
            ...
            if (formError != null) {
              print(
                  'GDPR Consent: Error showing privacy options form: ${formError
                      .message}');
            }
          ...
          (FormError? formError) {
        print('GDPR Consent: Error loading privacy options form: ${formError
            ?.message}');
      },
    );
  } catch(e){
